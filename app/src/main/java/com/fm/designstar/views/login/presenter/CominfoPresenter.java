...
public class CominfoPresenter extends BasePresenter<ComInfoContract.View> implements ComInfoContract.Presenter {
    @Override
    public void ComInfo(String avatar, String userName, String birthday, int sex,String address) {
        toSubscribe(HttpManager.getApi().comInfo(new comInfobody(avatar,  userName,  birthday,  sex,1,address)), new AbstractHttpSubscriber() {
            @Override
