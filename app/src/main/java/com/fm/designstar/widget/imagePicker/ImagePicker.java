package com.fm.designstar.widget.imagePicker;

import android.app.Activity;
import android.content.Intent;


import com.fm.designstar.widget.imagePicker.activity.ImagePickerActivity;
import com.fm.designstar.widget.imagePicker.manager.ConfigManager;
import com.fm.designstar.widget.imagePicker.utils.ImageLoader;
...
public class ImagePicker {
     ...
     * @param activity
     */
    public void start(Activity activity, int requestCode, int type) {
