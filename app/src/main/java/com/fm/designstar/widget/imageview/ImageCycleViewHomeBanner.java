 ...
 * @update : 2018/8/9
 */
public class ImageCycleViewHomeBanner extends LinearLayout implements View.OnTouchListener {
    /**
     * 上下文
     */
...
//    private ImageView mImageView = null;
     ...
     * @param context
     */
    public ImageCycleViewHomeBanner(Context context) {
        super(context);
        mContext = context;
        init();
    }
     ...
     * @param attrs
     */
    public ImageCycleViewHomeBanner(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
    ...
    private class ImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, final int position) {
            ...
            ViewGroup.LayoutParams lp = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, screenWidth / 3 * 2);
            ...
            if (StringUtil.isBlank(myUrls.get(position % myUrls.size()))) {
                ...
                Glide.with(mContext)
                        .load(OssImageUtil.getThumbnailCut(myUrls.get(position % myUrls.size()), screenWidth / 3*2 , screenWidth-80))
                        .apply(myOptions).into(imageView);
             //   Log.e("qsd","uir===="+myUrls.get(position % myUrls.size())+"=="+OssImageUtil.getThumbnailCut(myUrls.get(position % myUrls.size()), screenWidth / 3 * 2, screenWidth));
            }
