...
import static com.fm.designstar.utils.Util.getAndroidID;
import static com.fm.designstar.utils.Util.getPesudoUniqueID;
...
public class FormatUtil {
    ...
    public static boolean isNumeric(String str) {
        Matcher isNum = PatternUtil.DIGIT.matcher(str);
        if (!isNum.matches()) {
            return false;
        }
        return true;
    ...
    public static boolean isIdCardNo(String idNum){
        Matcher idNumMatcher = PatternUtil.ID_CARD.matcher(idNum);
    ...
    public static String getIMEI(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 29){
            try {
                ...
                imei = m_szUniqueID.toString().toUpperCase();
            } catch (Exception e) {
                e.printStackTrace();
            }
