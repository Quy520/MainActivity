...
public class SearchDesignerAdapter$LikeViewHolder_ViewBinding implements Unbinder {
  private SearchDesignerAdapter.LikeViewHolder target;

  @UiThread
  public SearchDesignerAdapter$LikeViewHolder_ViewBinding(
      SearchDesignerAdapter.LikeViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SearchDesignerAdapter.LikeViewHolder target = this.target;
