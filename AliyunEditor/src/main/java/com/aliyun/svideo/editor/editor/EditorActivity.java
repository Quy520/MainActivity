...
public class EditorActivity extends FragmentActivity {
   ...
   // private static final String NEXT_ACTIVITY_CLASS_NAME = "com.aliyun.apsara.alivclittlevideo.activity.PublishActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editView.setmOnFinishListener(new AlivcEditView.OnFinishListener() {
            ...
            public void onComplete(AlivcEditOutputParam outputParam) {
                ...
                Log.e("qsd","outputParam"+outputParam.getThumbnailPath()+"=="+new Gson().toJson(outputParam));
    ...
    private void initData() {
        ...
        int mFrameRate = intent.getIntExtra(AlivcEditInputParam.INTENT_KEY_FRAME, 25);
        int mGop = intent.getIntExtra(AlivcEditInputParam.INTENT_KEY_GOP, 50);
        int mRatio = intent.getIntExtra(AlivcEditInputParam.INTENT_KEY_RATION_MODE, AlivcEditInputParam.RATIO_MODE_ORIGINAL);
        ...
        int mResolutionMode = intent.getIntExtra(AlivcEditInputParam.INTENT_KEY_RESOLUTION_MODE, AlivcEditInputParam.RESOLUTION_540P);
        ...
        Log.e("qsd",""+"mGop"+mGop+"mFrameRate"+mFrameRate+"mVideoQuality"+mVideoQuality+"="+mResolutionMode);
